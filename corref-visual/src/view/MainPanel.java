    ...
    private MainPanel() throws ClassNotFoundException, NoSuchMethodException
    {
		...
		try {
			...
			e1.printStackTrace();
               ...
               //começo do codigo para selecionar sintagma
               //a partir do texto
                
//        textoPuroPane.getCaret().addChangeListener((ChangeEvent e) -> 
//        {
//            int initSelection = textoPuroPane.getCaret().getMark();
//            int endSelection = textoPuroPane.getCaret().getDot();
//            System.out.println(initSelection+" "+
//                               endSelection);
//            if(initSelection<texto.length()&&endSelection<texto.length()
//                    &&texto.charAt(endSelection)==' '&&initSelection!=endSelection)
//            {
//                System.out.println(texto.substring(initSelection, endSelection));
//                endSelection--;
...
//                    {
//                        Sintagma s = (Sintagma) model.get(i);
//                        if(s.startChar<=initSelection&&s.endChar>=endSelection)
//                            jl.setSelectedIndex(i);
//                    }
//                }  
//                highlightSelecionados();
//                textoPuroPane.getCaret().setDot(endSelection);
//            }   
//        });
        ...
        /*
            TODA a logica de importacao de xml
        */
        jMenuItemImportar.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                ...
                try
                {
                    ...
                    //JDOM entrando em acao
                    Document document = new SAXBuilder().build(isr);
                    tituloTexto = document.getRootElement().getName();
                    //lembrar que o XML eh uma ARVORE (la por outubro vai ficar claro)
                    //jdom pega os filhos de cada elemento ("nodo") e transforma em uma 
                    //lista indexada
                    ...
                    for (org.jdom2.Element mencao_unica : mencoes_unicas)
                    {
                        ...
                        {
                            //isso aqui acessa o elemento do jdom
                        ...
                        //cria o sintagma
                        //processa o elemento do jdom tambem
                    ...
                    for (Sintagma s : listaSintagma)
                        listaOriginal.add(s);
                    /*
                        parte medonha da interface grafica
                    */
    ...
    public void highlightSintagma(Sintagma s)
    {
        ...
        System.out.println(s.sn+" : "+s.startChar+" "+s.endChar);
    }
